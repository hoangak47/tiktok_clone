...
import { faCircleXmark, faEllipsisV, faSpinner, faPlus } from '@fortawesome/free-solid-svg-icons';
...
import { Coins, Feedback, Keyboard, Language, Logout, Mess, Notify, Search, Settings, User } from '~/components/Icons';
